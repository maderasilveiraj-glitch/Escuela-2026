...
Core Académico también puede convertirse en una app Android real mediante Capacitor. Consulta `ANDROID.md` o ejecuta el workflow **Android APK - Core Académico** desde GitHub Actions para generar `app-debug.apk`.

...
## Build Android actualizado
El workflow de GitHub Actions usa Node.js 22, Java 21, instala TypeScript, prepara `www`, crea/sincroniza Capacitor Android y genera `Core-Academico.apk` como Artifact.
